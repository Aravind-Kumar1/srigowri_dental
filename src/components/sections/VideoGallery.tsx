  ...
  return (
    <section id="video-gallery" className="section-padding overflow-hidden bg-background">
      ...
      <div className="w-full relative mt-10">
        ...
        <div className="relative flex overflow-hidden group/marquee w-full py-10 select-none gap-6 md:gap-8">
          <div 
            className="flex gap-6 md:gap-8 shrink-0 animate-marquee group-hover/marquee:[animation-play-state:paused]"
          ...
          >
            {videos.map((video, idx) => (
              <VideoCard key={`${idx}-dup`} video={video} onPlayChange={handlePlayChange} />
            ))}
          </div>
        </div>
      </div>
