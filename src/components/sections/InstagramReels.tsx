...
const reels = [
  { id: "sample1", title: "Patient Education" },
  { id: "sample2", title: "Clinic Excellence" },
  { id: "sample3", title: "Advanced Technology" },
  { id: "sample4", title: "Smile Transformations" },
  { id: "sample5", title: "Dental Tips" },
  { id: "sample6", title: "Facility Tour" },
  { id: "sample7", title: "Success Stories" },
];
      ...
      <div className="container-custom">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <motion.p
            ...
            className="text-body"
          >
            Follow our journey for daily dental tips, patient transformations, and behind-the-scenes glances at our modern facility.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {reels.map((reel, index) => (
            ...
            >
              {/* Cropped Iframe Container - Placeholder */}
              <div className="absolute inset-0 z-0 overflow-hidden bg-slate-200 flex items-center justify-center">
                <div className="text-slate-400 font-bold uppercase tracking-widest text-xs text-center px-4">
        ...
        >
          ...
          >
            <span>DISCOVER ON SOCIAL MEDIA</span>
